    ...
    value: function notification() {
      if (this.state.isDisplayed) {
        ...
        return React.createElement(
          NotifyContainer,
          { color: type },
          React.createElement(NotifyIcon, { type: icon }),
          React.createElement(NotifyContent, { text: text }),
          React.createElement(Close, { onCloseHandler: this.onCloseHandler })
        );
      }
      return null;
    }
    ...
    value: function minimizeNotification() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('i', { className: ['fa fa-arrow-down', styles.icon].join(' '), 'aria-hidden': 'true' })
        )
      );
    }
  }, {
...
function NotifyIcon(props) {
  return React.createElement(
    ...
    React.createElement('i', { className: props.type, 'aria-hidden': 'true' })
  );
}
